...
public class EmployeeDataHQLASClauseTest {
    ...
    public static void main(String[] args) {
        File file = new File(EmployeeDataHQLASClauseTest.class.getClassLoader().getResource("hibernate_hql.cfg.xml").getFile());
        SessionFactory sessionFactory = new Configuration().configure(file)
                .buildSessionFactory();
        Session session = sessionFactory.openSession();
//        String hql  = "FROM Employee AS e";
        String hql  = "FROM org.vinaylogics.hibernatebasics.annotation.hql.models.HqlEmployee AS e";
