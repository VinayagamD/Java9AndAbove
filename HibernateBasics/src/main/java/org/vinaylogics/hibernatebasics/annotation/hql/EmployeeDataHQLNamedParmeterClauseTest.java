...
public class EmployeeDataHQLNamedParmeterClauseTest {
    ...
    public static void main(String[] args) {
        File file = new File(EmployeeDataHQLNamedParmeterClauseTest.class.getClassLoader().getResource("hibernate_hql.cfg.xml").getFile());
        SessionFactory sessionFactory = new Configuration().configure(file)
                .buildSessionFactory();
        Session session = sessionFactory.openSession();
        String hql  = " FROM CMyEmployee AS e WHERE e.id = :id";
//        String hql  = "FROM org.vinaylogics.hibernatebasics.annotation.hql.models.Employee AS e";
        ...
        query.setParameter("id", 62);
        List<HqlEmployee> rows = query.list();
